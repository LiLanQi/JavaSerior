...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "分销员销售价格")
    ...
    @ApiModelProperty(value = "和source配合使用，第三方id")
    ...
    @ApiModelProperty(value = "sku 数据")
    private List<PmsSkuStock> skuList = new ArrayList<>();
    ...
    public void addStockSku(PmsSkuStock sku) {
